...
3. Install Excel and [Excel Solver](https://support.microsoft.com/en-us/office/load-the-solver-add-in-in-excel-612926fc-d53b-46b4-872c-e24772f078ca) on your machine. 
4. Check **UBLearns** and your **UB email** regularly for course updates and announcements.  
5. Stay current with class lectures — this is key to earning a good grade.   
6. All material covered in lectures is also included in your assigned readings. Your textbook remains your most reliable reference and should always be accessible.  
7. 🚫 Eating or drinking is not permitted during class sessions.  
8. 📧 All email communications must include **"MGO-636"** in the subject line to ensure a timely response.
...
3. **Midterm 1 (15%)**  
- Administered at the beginning of Week 7.  
...
| 2    | Sep 1        | Labor Day                                       | 7-11 Japan case (end of Chapter 3)                    | <span style="background-color:#FFDDC1">Final project team formation – submit member names</span> |   No class meeting    |
| 3    | Sep 8        | Supply Chain Drivers and Networks                         | Chapters 3 & 4                                        | <span style="background-color:#C1E1FF">Individual Homework 1: Blockbuster Case (end of Chapter 2)</span> |       |
| 4    | Sep 15       | Supply Chain Network Design                       | Chapters 5                                        | <span style="background-color:#C1E1FF">Individual Homework 2: Blue Nile Case (end of Chapter 4)</span>; <span style="background-color:#FFDDC1">Finalize your final project topic</span> |       |
| 5    | Sep 22       | Global Supply Chain Network Design         | Chapters 6                                       | <span style="background-color:#C1E1FF">Individual Homework 3: Coolwipes Case (end of Chapter 5)</span> |       |
| 6    | Sep 29       |  Linear Programming and Aggregate Planning   | Chapter 8 (and parts of 9)                                            |<span style="background-color:#D5F5E3">Group Assignment 1: BioPharma Case (end of Chapter 6)</span>  | |
| 7    | Oct 6        | **Midterm 1** + Supply Chain Forecasting          | Chapters 7    | <span style="background-color:#FFD6D6">**Midterm 1**</span> | Midterm 1 covering Chapters 1–6, administered in first part of class      |
| 8    | Oct 13       | Fall Break                                                | —                                                     | <span style="background-color:#FFDDC1">Final project proposal due on UBLearns</span> | No class meeting |
| 9    | Oct 20       | Inventory Control: Cycle Inventory                        | Chapter 11                                            | <span style="background-color:#D5F5E3">Group Assignment 2: Mintendo Game Girl (end of Chapter 9)</span> |       |
| 10   | Oct 27       | Inventory Control: Safety Inventory                     | Chapter 12                                            | <span style="background-color:#C1E1FF">Individual Homework 4: EOQ (UBLearns)</span> |       |
| 11   | Nov 3        | Inventory Control: Seasonal Inventory                     | Chapter 13                                            | <span style="background-color:#D5F5E3">Group Assignment 3: ALKO Case (end of Chapter 12)</span> |       |
| 12   | Nov 10       | Transportation Networks and Last Mile Delivery       | Chapter 14	                                | —                                                                             |  |
| 13   | Nov 17       | **Midterm 2**                         |                                             | <span style="background-color:#FFD6D6">**Midterm 2**</span> | Midterm 2 ocvers Chapters 9, 11, 12, and 13. |
| 14   | Nov 24       | Supply Chain Coordination and Bullwhip Effect |  Chapter 15                                            | <span style="background-color:#D5F5E3">Group Assignment 4: Barilla SpA Case (HBS Case Pack)</span> |    We play a supply chain coordination game in class.   |
| 15   | Dec 1        | Pricing and Revenue Management                            | Chapter 16                                            | —                                                                             |       |
